...
static bool coco3_finish(struct part *p) {
	...
	// has_secb is unused for fetch/video; 1.12.1 used this same call.
	// Preload NTSC 0xb4c88d6c so verify accepts Glen’s dump even if
	// @coco3 was wiped by xroar.conf.
